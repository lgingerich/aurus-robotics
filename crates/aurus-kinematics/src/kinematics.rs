...
mod tests {
    ...
    fn test_kinematics_constructor() {
        let kinematics = 2WDKinematics::new(0.1, 0.5);
    ...
    fn test_constructor_invalid_radius() {
        2WDKinematics::new(0.0, 0.5);
    }

    #[test]
    #[should_panic]
    fn test_constructor_invalid_axle_length() {
        2WDKinematics::new(0.1, -0.5);
    }

    #[test]
    fn test_forward_kinematics_straight() {
        let kinematics = 2WDKinematics::new(0.1, 0.5); // r=0.1m, L=0.5m
